...
export const USERS_KEY = 'org.beacon.users!';
export const FRIENDS_KEY = (userHash: string) =>
  `${USERS_KEY}${userHash}!org.beacon.friends!`;
export const FRIENDS_BY_NAME_KEY = (userHash: string) =>
  `${USERS_KEY}${userHash}!org.beacon.friendsByName!`;
export const FRIENDS_BY_EMAIL_KEY = (userHash: string) =>
  `${USERS_KEY}${userHash}!org.beacon.friendsByEmail!`;
